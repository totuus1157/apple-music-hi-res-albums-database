...
export const metadata: Metadata = {
  ...
  description:
    "Discover over 45,000 Apple Music Hi-Res albums in our searchable database. Filter by artist, genre, composer, or sample rate to find exactly what you’re looking for.",
  openGraph: {
